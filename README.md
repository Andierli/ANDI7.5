...
```
(CMD)
git clone https://github.com/Andierli
git init
git add .
git commit -m "OK"
...
[![Heroku Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/Andierli/ANDI7.5)
